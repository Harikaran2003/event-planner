...
import { Calendar, Plus, Search, Bell, User, LogOut, Menu, X, CheckCircle, Clock, AlertCircle, Edit, Trash2, Check, XCircle, Star } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto">
              <nav className="px-2 py-4 space-y-1">
                ...
                <button 
                  ...
                  className={`${activeTab === 'feedback' ? 'bg-gray-100 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'} group flex items-center px-2 py-2 text-base font-medium rounded-md w-full text-left`}
                >
                  <Star className="mr-4 h-6 w-6 text-gray-500" />
                  Feedback
                </button>
              </nav>
            </div>
              ...
              <div className="mt-5 flex-1 flex flex-col">
                <nav className="flex-1 px-2 space-y-1">
                  ...
                  <button 
                    ...
                    className={`${activeTab === 'feedback' ? 'bg-gray-100 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'} group flex items-center px-2 py-2 text-sm font-medium rounded-md w-full text-left`}
                  >
                    <Star className="mr-3 h-6 w-6 text-gray-500" />
                    Feedback
                  </button>
                </nav>
              </div>
                      ...
                      <div className="bg-white rounded-xl shadow-md p-6">
                        ...
                        {feedback.length === 0 ? (
                          <div className="text-center py-12">
                            ...
                            <p className="mt-1 text-sm text-gray-500">Customers haven't submitted any feedback yet.</p>
                          </div>
                        ) : (
                          <div className="flow-root">
                            <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                              <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                <table className="min-w-full divide-y divide-gray-300">
                                  <thead>
                                    <tr>
                                      <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">Feedback ID</th>
                                      <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">User</th>
                                      <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Event</th>
                                  ...
                                  <tbody className="divide-y divide-gray-200">
                                    {feedback.map((item) => (
                                      <tr key={item.id}>
                                        <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">#{item.id}</td>
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                          <div>{item.user.fullName}</div>
                                          <div className="text-gray-400">{item.user.email}</div>
                                        </td>
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{item.event.name}</td>
                                        <td className="whitespace-nowrap px-3 py-4 text-sm">
                                          <div className="flex items-center">
                                            {[...Array(5)].map((_, i) => (
                                              <Star 
                                        ...
                                        <td className="px-3 py-4 text-sm text-gray-500">{item.comment || 'No comment'}</td>
